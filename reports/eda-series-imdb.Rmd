...
well_rated_series = series_by_season %>% 
  filter(!(series_name %in% bad_rated_series$series_name))
```

Até agora, as únicas séries que conseguiram se manter bem avaliadas em todas as temporadas, foram Super Girl, The Originals, Daredevi, Person of Interest e Outlander.
